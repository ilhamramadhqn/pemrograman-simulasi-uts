<?php
$con = mysqli_connect('localhost', 'root', '', 'dbabsensi_murid') or die(mysqli_error());
session_start();
?>
                ...
                <div class="header-wrap">
                    ...
                    <div class="header__navbar">
                        <ul class="list-unstyled">
                            <?php if ( $_GET['p'] == 'home' || $_GET['p'] == 'welcome') { ?> <li class="active"> <?php } else { ?> <li> <?php } ?>
                            ...
                            <?php if ( $_GET['p'] == 'interval' ) { ?> <li class="active"> <?php } else { ?> <li> <?php } ?>
                                <a href="home.php?p=interval">
                                    ...
                                    <span class="bot-line"></span>Interval</a>
                            </li>
