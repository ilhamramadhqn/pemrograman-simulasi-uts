                ...
                <div class="col-md-8 offset-2">
                    ...
                    <div class="table-responsive table-responsive-data2">
                        <table class="table table-data2 text-center">
                            ...
                            <?php
                            $no = 1;
                            $sqls = mysqli_query($con, "SELECT b.nama_bulan, a.bilangan_acak FROM bulan b, acak2017_2018 a WHERE b.kd_bulan = a.kd_bulan ") or die(mysqli_error($con));
                            foreach ($sqls as $sql) { ?>
                                <tr>
                                    <td><?= $no++ ?></td>
                                    ...
                                    <td>
                                        <?php
                                        $ranges = mysqli_query($con, "SELECT * FROM range2017_2018") or die(mysqli_error($con));
