...
if ( isset($_POST['simpan-interval']) ) {
    ...
    mysqli_query($con, "DELETE FROM range2017_2018") or die(mysqli_error($con));
    ...
    for ($i=1; $i <= $jumlah; $i++) { 
        ...
        mysqli_query($con, "INSERT INTO range2017_2018 (kehadiran, awal, akhir) VALUES ('$kehadiran', '$awal', '$akhir')") or die(mysqli_error($con));
