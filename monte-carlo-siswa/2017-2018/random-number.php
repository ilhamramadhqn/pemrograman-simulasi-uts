...
<?php } ?>
    ...
    if ( isset($_POST['proses']) ) {
        ...
        mysqli_query($con, "DELETE FROM acak2016_2017") or die(mysqli_error($con)); 
        ...
        for ($i=1; $i <= $jumlah ; $i++) { 
            ...
            mysqli_query($con, "INSERT INTO acak2016_2017 ( kd_bulan, bilangan_acak ) VALUES ('$kode_bulan', '$random_number')") or die(mysqli_error($con));
        }
